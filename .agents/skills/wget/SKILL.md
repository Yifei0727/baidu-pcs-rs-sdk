...
```bash
baidu-pcs-cli-rs wget <分享链接> [-p <提取码>] [-o <本地目录>]
```
...
```bash
# 下载无提取码的分享链接
baidu-pcs-cli-rs wget https://pan.baidu.com/s/1abcdef1234567

# 下载带提取码的分享链接
baidu-pcs-cli-rs wget https://pan.baidu.com/s/1abcdef1234567 -p xk9f

# 下载到指定目录
baidu-pcs-cli-rs wget https://pan.baidu.com/s/1abcdef1234567 -p xk9f -o ~/下载/分享文件
```
